 ...
 *
 * <p>Không bao giờ chứa hashedPassword. Balance chỉ gửi về đúng chủ tài khoản hoặc Admin.
 */
public class UserDTO {
  ...
  public void setTimesRestored(int timesRestored) {
  ...
  public String getActiveBanReason() {
    return activeBanReason;
  }

  public void setActiveBanReason(String activeBanReason) {
    this.activeBanReason = activeBanReason;
  }
  ...
  public String getActiveBanNote() {
    return activeBanNote;
  }

  public void setActiveBanNote(String activeBanNote) {
    this.activeBanNote = activeBanNote;
  }
}
