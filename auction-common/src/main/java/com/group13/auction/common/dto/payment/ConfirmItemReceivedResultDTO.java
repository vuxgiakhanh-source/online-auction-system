...
/**
 * Payload của CONFIRM_ITEM_RECEIVED_SUCCESS.
 * Server trả về sau khi winner xác nhận đã nhận hàng.
 *
 * <p>{@code canSubmitReport = true} — client dùng để enable nút báo cáo chất lượng.
 * {@code reportDeadline} — deadline để submit Quality Report (3 ngày kể từ khi xác nhận).
 */
public class ConfirmItemReceivedResultDTO {
  ...
  public void setCanSubmitReport(boolean canSubmitReport) { this.canSubmitReport = canSubmitReport; }
