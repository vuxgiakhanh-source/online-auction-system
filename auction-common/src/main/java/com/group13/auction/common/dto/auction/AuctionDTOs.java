...
public final class AuctionDTOs {
  ...
  public static class ItemDTO {
    ...
    /**
     * Danh sách URL ảnh sản phẩm dạng "/uploads/items/{uuid}.jpg". Null-safe: null khi client cũ
     * nhận từ server cũ chưa có field này. Dùng hasImages() để kiểm tra an toàn.
     */
    ...
    public void setExtraFields(java.util.Map<String, Object> extraFields) {
  ...
  public static class AuctionDTO {
    ...
    /**
     * Trạng thái thanh toán của AuctionWinner (PENDING, FUNDS_HELD, ITEM_RECEIVED, ...). Null nếu
     * auction chưa FINISHED hoặc chưa có winner. Client dùng để hiển thị đúng trạng thái đơn hàng
     * sau refresh.
     */
    ...
    /**
     * User hiện tại đã rời phiên này chưa (LEAVE_AUCTION, không thể join lại). Server điền dựa trên
     * {@code user.hasLeft(auctionId)}. Null nếu request không gắn với user cụ thể. Client dùng để
     * ẩn nút "Tham gia đặt giá" và không cần gửi JOIN rồi bị reject.
     */
    ...
    public LocalDateTime getExtendedEndTime() {
      return extendedEndTime;
    }

    public void setExtendedEndTime(LocalDateTime extendedEndTime) {
    ...
    public void setConfirmReceiptDeadline(LocalDateTime d) {
      this.confirmReceiptDeadline = d;
    }
    ...
    public Boolean getLeftByCurrentUser() {
      return leftByCurrentUser;
    }

    public void setLeftByCurrentUser(Boolean leftByCurrentUser) {
  ...
  public static class CreateAuctionRequestDTO {
    ...
    /**
     * Danh sách URL ảnh sản phẩm (đã upload lên ImageUploadServer). Mỗi phần tử là URL dạng
     * "/uploads/items/{uuid}.jpg". Null hoặc rỗng nếu seller không upload ảnh.
     */
    private List<String> imageUrls;
    ...
    public java.util.Map<String, Object> getItemExtraFields() {
      return itemExtraFields;
    }

    public void setItemExtraFields(java.util.Map<String, Object> f) {
      this.itemExtraFields = f;
    }
  ...
  public static class AuctionListRequestDTO {
     ...
     *
     * <ul>
     *   <li>{@code ALL} — tất cả phiên (mặc định, không lọc thêm).
     *   <li>{@code OWNED} — phiên do user hiện tại tạo (seller).
     *   <li>{@code JOINED} — phiên user đã tham gia đặt cọc.
     *   <li>{@code WATCHING} — phiên user đang theo dõi.
     * </ul>
     *
  ...
  public static class UpdateAuctionDTO {
    ...
    public Double getNewReservePrice() {
      return newReservePrice;
    }

    public void setNewReservePrice(Double newReservePrice) {
  ...
  public static class AuctionExtendedDTO {
    ...
    public int getExtendedBySeconds() {
      return extendedBySeconds;
    }

    public void setExtendedBySeconds(int extendedBySeconds) {
  ...
  public static class JoinAuctionResponseDTO {
    ...
    public void setNewAvailableBalance(double newAvailableBalance) {
  ...
  public static class LeaveAuctionResponseDTO {
    ...
    public void setDepositForfeited(boolean v) {
      this.depositForfeited = v;
    }

    public long getForfeitedAmount() {
      return forfeitedAmount;
    }

    public void setForfeitedAmount(long v) {
      this.forfeitedAmount = v;
    }

    public boolean isRatingPenalized() {
      return ratingPenalized;
    }

    public void setRatingPenalized(boolean v) {
      this.ratingPenalized = v;
    }

    public long getNewAvailableBalance() {
      return newAvailableBalance;
    }

    public void setNewAvailableBalance(long v) {
