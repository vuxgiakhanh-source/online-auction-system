...
public final class PaymentDTOs {
  ...
  public static class DepositRequestDTO {
    ...
    public DepositRequestDTO(long amount) {
      this.amount = amount;
    }
  ...
  public static class WithdrawRequestDTO {
    ...
    public WithdrawRequestDTO(long amount) {
      this.amount = amount;
    }
  ...
  public static class WalletBalanceResponseDTO {
    ...
    public void setLockedDeposit(long lockedDeposit) {
      this.lockedDeposit = lockedDeposit;
    }
  ...
  public static class PaymentRequestDTO {
    ...
    public PaymentRequestDTO(String auctionId) {
  ...
  public static class PaymentExpiredDTO {
    ...
    public long getDepositForfeited() {
      return depositForfeited;
    }

    public void setDepositForfeited(long depositForfeited) {
      this.depositForfeited = depositForfeited;
    }

    public double getRatingPenalty() {
      return ratingPenalty;
    }

    public void setRatingPenalty(double ratingPenalty) {
  ...
  public static class DepositForfeitedDTO {
    ...
    public void setForfeitedAmount(long forfeitedAmount) {
  ...
  public static class SecondChanceOfferDTO {
    ...
    public long getDepositRequired() {
      return depositRequired;
    }

    public void setDepositRequired(long depositRequired) {
  ...
  public static class ConfirmItemReceivedResultDTO {
    ...
    public void setCanSubmitReport(boolean v) {
      this.canSubmitReport = v;
    }
    ...
    public void setConfirmedAt(java.time.LocalDateTime v) {
      this.confirmedAt = v;
    }

    public java.time.LocalDateTime getReportDeadline() {
      return reportDeadline;
    }

    public void setReportDeadline(java.time.LocalDateTime v) {
      this.reportDeadline = v;
    }
  }
}
