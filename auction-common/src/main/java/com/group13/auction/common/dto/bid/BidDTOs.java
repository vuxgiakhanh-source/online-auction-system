...
public final class BidDTOs {
    ...
    public static class BidRequestDTO {
        ...
        public BidRequestDTO(String auctionId, double amount) {
    ...
    public static class AutoBidRequestDTO {
        ...
        public AutoBidRequestDTO(String auctionId, double maxBid) {
            this.auctionId = auctionId;
            this.maxBid = maxBid;
        }
    ...
    public static class AutoBidRegistrationDTO {
        private String auctionId;
        private double maxBid;
        private double currentSystemBid;
        ...
        public double getMaxBid() { return maxBid; }
        public void setMaxBid(double maxBid) { this.maxBid = maxBid; }
        public double getCurrentSystemBid() { return currentSystemBid; }
        public void setCurrentSystemBid(double currentSystemBid) { this.currentSystemBid = currentSystemBid; }
    ...
    public static class AutoBidTriggeredDTO {
        ...
        private double newCurrentPrice;
        private double remainingMaxBid;
        ...
        public double getNewCurrentPrice() { return newCurrentPrice; }
        public void setNewCurrentPrice(double newCurrentPrice) { this.newCurrentPrice = newCurrentPrice; }
        public double getRemainingMaxBid() { return remainingMaxBid; }
        public void setRemainingMaxBid(double remainingMaxBid) { this.remainingMaxBid = remainingMaxBid; }
