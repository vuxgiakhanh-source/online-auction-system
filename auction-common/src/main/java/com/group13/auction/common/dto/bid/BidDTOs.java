...
public final class BidDTOs {
  ...
  /**
   * Payload của BID_UPDATE và BID_RESERVE_NOT_MET_UPDATE (broadcast). Gửi cho tất cả client đang
   * xem phiên.
   */
  public static class BidUpdateDTO {
    ...
    /**
     * FIX: Giá trước khi bid này được chấp nhận. Client dùng để hiển thị hướng tăng/giảm (trong đấu
     * giá luôn tăng) và delta: "+50.000đ".
     */
    private long previousPrice;

    /**
     * FIX: Delta = newCurrentPrice - previousPrice. Luôn dương trong đấu giá hợp lệ. Client hiển
     * thị trực tiếp: "+200.000đ" mà không cần tính thêm.
     */
    ...
    public long getNewCurrentPrice() {
      return newCurrentPrice;
    }

    public void setNewCurrentPrice(long newCurrentPrice) {
  ...
  public static class AutoBidRegistrationDTO {
    ...
    public long getCurrentSystemBid() {
      return currentSystemBid;
    }

    public void setCurrentSystemBid(long currentSystemBid) {
      this.currentSystemBid = currentSystemBid;
    }
  ...
  /**
   * Payload của AUTO_BID_TRIGGERED_NOTIFY. Push riêng tới client có auto-bid đang hoạt động khi hệ
   * thống tự bid thay.
   */
  public static class AutoBidTriggeredDTO {
    ...
    public long getRemainingMaxBid() {
      return remainingMaxBid;
    }

    public void setRemainingMaxBid(long remainingMaxBid) {
      this.remainingMaxBid = remainingMaxBid;
    }

    public boolean isNowLeading() {
      return isNowLeading;
    }

    public void setNowLeading(boolean nowLeading) {
      isNowLeading = nowLeading;
    }
  ...
  /** Payload của OUTBID_NOTIFY. Push riêng tới bidder bid thủ công khi bị người khác vượt giá. */
  public static class OutbidNotifyDTO {
    ...
    public String getNewBidderUsername() {
      return newBidderUsername;
    }

    public void setNewBidderUsername(String newBidderUsername) {
      this.newBidderUsername = newBidderUsername;
    }
  }

  /**
   * Payload của AUTO_BID_EXHAUSTED_NOTIFY. Push khi auto-bid bị đối thủ vượt và maxBid đã cạn kiệt.
   */
  ...
  public static class BidHistoryResponseDTO {
    ...
    public List<BidChartPointDTO> getPoints() {
      return points;
    }

    public void setPoints(List<BidChartPointDTO> points) {
      this.points = points;
    }
   ...
   *
   * <p>Broadcast tới tất cả watcher mỗi khi số người đang xem thay đổi: join, watch, leave, hoặc
   * disconnect.
   *
   * <p><b>activeViewerCount</b> = số WebSocket connection đang live tại thời điểm event, KHÔNG phải
   * tổng lịch sử. Client dùng giá trị này để hiển thị "X người đang xem".
   */
  public static class ViewerCountUpdateDTO {
    ...
    public void setActiveViewerCount(int activeViewerCount) {
      this.activeViewerCount = activeViewerCount;
    }
  }
}
