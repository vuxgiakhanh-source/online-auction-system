...
public final class ChatbotDTOs {
    ...
    public static class ChatbotFaqListResponseDTO {
        ...
        public ChatbotResponseDTO getHeader() { return header; }
        public void setHeader(ChatbotResponseDTO header) { this.header = header; }
        public java.util.List<FaqSummaryDTO> getFaqs() { return faqs; }
        public void setFaqs(java.util.List<FaqSummaryDTO> faqs) { this.faqs = faqs; }
