...
class AuctionDTOsTest {
  ...
  class ItemDTOTest {
    ...
    @Test
    @DisplayName("default constructor — tất cả null/zero")
    void defaults() {
    ...
    @Test
    @DisplayName("category — 3 giá trị hợp lệ")
    ...
    @Test
    @DisplayName("imageUrls rỗng → hasImages() = false")
    ...
    @Test
    @DisplayName("imageUrls null → hasImages() = false, không NPE")
  ...
  class AuctionDTOTest {
    ...
    @Test
    @DisplayName("default constructor — tất cả null/zero/false")
    void defaults() {
    ...
    @Test
    @DisplayName("status — 6 giá trị hợp lệ theo contract")
    void status_validValues() {
      for (String s :
          new String[] {"OPEN", "RUNNING", "FINISHED", "PAID", "CANCELED", "RESERVE_NOT_MET"}) {
        AuctionDTOs.AuctionDTO dto = new AuctionDTOs.AuctionDTO();
        dto.setStatus(s);
  ...
  class AuctionListDTOTest {
    ...
    @Test
    @DisplayName("default constructor — auctions null, counts zero")
    void defaults() {
    ...
    @Test
    @DisplayName("2-arg constructor — auctions và totalCount set")
    ...
    @Test
    @DisplayName("page và pageSize — set/get đúng")
    void pageFields() {
      AuctionDTOs.AuctionListDTO dto = new AuctionDTOs.AuctionListDTO();
      dto.setPage(2);
      dto.setPageSize(10);
  ...
  class CreateAuctionRequestDTOTest {
    ...
    @Test
    @DisplayName("default constructor — fields null/zero")
    void defaults() {
    ...
    @Test
    @DisplayName("imageUrls null — không NPE")
  ...
  class AuctionListRequestDTOTest {
    ...
    @Test
    @DisplayName("default constructor — page=0, pageSize=20")
    void defaults() {
  ...
  class UpdateAuctionDTOTest {
    ...
    @Test
    @DisplayName("newReservePrice null — không đổi reserve")
  ...
  class AdminCancelAuctionDTOTest {
    ...
    @Test
    @DisplayName("reason — các giá trị hợp lệ")
  ...
  class AuctionUpcomingEndDTOTest {
    ...
    @Test
    @DisplayName("remainingSeconds = 0 — boundary")
