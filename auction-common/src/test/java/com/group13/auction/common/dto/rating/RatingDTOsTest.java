...
class RatingDTOsTest {
  ...
  @Nested
  @DisplayName("RateSellerRequestDTO")
  ...
  @Nested
  @DisplayName("RateBidderRequestDTO")
  ...
  class RatingEntryDTOTest {
    ...
    void settersGetters() {
      ...
      dto.setFromUserId("u-1");
      dto.setFromUsername("alice");
      dto.setRating(5.0);
      dto.setComment("Xuất sắc");
      dto.setCreatedAt(ts);
  ...
  class RatingHistoryDTOTest {
    ...
    @Test
    @DisplayName("setters / getters — roundtrip với entries")
    void withEntries() {
      RatingDTOs.RatingHistoryDTO dto = new RatingDTOs.RatingHistoryDTO();
      ...
      dto.setTotalRatings(1);
      dto.setEntries(Arrays.asList(entry));
