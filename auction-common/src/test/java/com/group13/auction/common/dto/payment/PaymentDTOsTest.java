...
class PaymentDTOsTest {
  ...
  @Nested
  @DisplayName("DepositRequestDTO")
  class DepositRequestDTOTest {
    @Test
    @DisplayName("default constructor — amount zero")
    void defaults() {
      assertThat(new PaymentDTOs.DepositRequestDTO().getAmount()).isZero();
    }

    @Test
    @DisplayName("1-arg constructor — amount set")
    void oneArgConstructor() {
      assertThat(new PaymentDTOs.DepositRequestDTO(500_000L).getAmount()).isEqualTo(500_000L);
    }

    @Test
    @DisplayName("setAmount / getAmount — roundtrip")
    void setter() {
  ...
  @Nested
  @DisplayName("WithdrawRequestDTO")
  class WithdrawRequestDTOTest {
    ...
    @Test
    @DisplayName("setAmount — roundtrip")
    void setter() {
  ...
  @Nested
  @DisplayName("WalletBalanceResponseDTO")
  class WalletBalanceResponseDTOTest {
    @Test
    @DisplayName("default constructor — tất cả zero")
    void defaults() {
    ...
    @Test
    @DisplayName("3-arg constructor — fields set")
    ...
    @Test
    @DisplayName("balance = lockedDeposit + availableBalance khi set đúng")
    void balanceInvariant() {
      PaymentDTOs.WalletBalanceResponseDTO dto =
          new PaymentDTOs.WalletBalanceResponseDTO(10_000_000L, 500_000L, 9_500_000L);
      assertThat(dto.getLockedDeposit() + dto.getAvailableBalance()).isEqualTo(dto.getBalance());
    }
  }

  @Nested
  @DisplayName("PaymentRequestDTO")
  class PaymentRequestDTOTest {
    @Test
    @DisplayName("1-arg constructor — auctionId set")
    void oneArgConstructor() {
      assertThat(new PaymentDTOs.PaymentRequestDTO("a-1").getAuctionId()).isEqualTo("a-1");
    }

    @Test
    @DisplayName("default constructor + setter")
    void setter() {
  ...
  class PaymentResultDTOTest {
    ...
    void settersGetters() {
      ...
      dto.setFinalPrice(8_000_000L);
      dto.setDepositDeducted(500_000L);
      dto.setRemainingToPay(7_500_000L);
      dto.setNewBalance(2_000_000L);
    ...
    @Test
    @DisplayName("paymentStatus — COMPLETED / PENDING")
  ...
  class PaymentExpiredDTOTest {
    ...
    void settersGetters() {
      ...
      dto.setAuctionId("a-1");
      dto.setDepositForfeited(500_000L);
      dto.setRatingPenalty(0.5);
  ...
  class DepositRefundDTOTest {
    ...
    void settersGetters() {
      ...
      dto.setAuctionId("a-1");
      dto.setRefundAmount(500_000L);
      dto.setNewBalance(9_500_000L);
  ...
  @Nested
  @DisplayName("DepositForfeitedDTO")
  class DepositForfeitedDTOTest {
    ...
    void settersGetters() {
      ...
      dto.setAuctionId("a-1");
      dto.setForfeitedAmount(500_000L);
      dto.setNewBalance(0L);
  ...
  @Nested
  @DisplayName("SecondChanceOfferDTO")
  class SecondChanceOfferDTOTest {
    ...
    void settersGetters() {
      ...
      dto.setOfferId("offer-1");
      dto.setAuctionId("a-1");
      dto.setAuctionItemName("Xe máy");
      dto.setOfferPrice(6_000_000L);
      dto.setDepositRequired(300_000L);
