...
class ErrorDTOTest {
    ...
    class ConstructorTest {
        ...
        @Test @DisplayName("default constructor — tất cả null")
        ...
        @Test @DisplayName("2-arg constructor — requestId null")
        ...
        @Test @DisplayName("3-arg constructor — đủ 3 field")
    ...
    class StaticFactoryTest {
        ...
        @Test @DisplayName("of(code, message) — requestId null")
        void of_twoArg() {
        ...
        @Test @DisplayName("of(code, message, requestId) — đủ 3 field")
        void of_threeArg() {
        ...
        @Test @DisplayName("of() trả object mới mỗi lần — không shared instance")
    ...
    class ErrorCodeConstantsTest {
        ...
        @Test @DisplayName("mỗi constant bằng đúng tên của nó — no typo")
    ...
    class ToStringTest {
        ...
        @Test @DisplayName("toString chứa code và message")
    ...
    class SettersGettersTest {
        ...
        @Test @DisplayName("setCode / getCode — roundtrip")
        void code_roundtrip() {
            ErrorDTO dto = new ErrorDTO();
        ...
        @Test @DisplayName("setMessage / getMessage — roundtrip")
