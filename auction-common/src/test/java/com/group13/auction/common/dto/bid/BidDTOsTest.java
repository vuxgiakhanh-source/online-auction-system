...
class BidDTOsTest {
    ...
    @Nested @DisplayName("BidRequestDTO")
    class BidRequestDTOTest {
        @Test @DisplayName("default constructor — null/zero")
        void defaults() {
        ...
        void settersGetters() {
            BidDTOs.BidRequestDTO dto = new BidDTOs.BidRequestDTO();
            dto.setAuctionId("a-2"); dto.setAmount(999L);
            assertThat(dto.getAuctionId()).isEqualTo("a-2");
            assertThat(dto.getAmount()).isEqualTo(999L);
        }
    }

    @Nested @DisplayName("BidResultDTO")
    class BidResultDTOTest {
        @Test @DisplayName("defaults — null/zero/false")
        void defaults() {
        ...
        void settersGetters() {
            ...
            dto.setBidId("bid-1"); dto.setAuctionId("a-1");
            dto.setAmount(3_000_000L); dto.setReserveMet(true);
            dto.setCurrentPrice(3_000_000L); dto.setTimestamp(ts);
    ...
    @Nested @DisplayName("BidUpdateDTO")
    class BidUpdateDTOTest {
        ...
        void settersGetters() {
            BidDTOs.BidUpdateDTO dto = new BidDTOs.BidUpdateDTO();
            LocalDateTime ts = LocalDateTime.now();
            dto.setAuctionId("a-1"); dto.setNewCurrentPrice(4_000_000L);
            dto.setLeaderId("u-1"); dto.setLeaderUsername("alice");
            dto.setReserveMet(true); dto.setTimestamp(ts);
    ...
    @Nested @DisplayName("AutoBidRequestDTO")
    class AutoBidRequestDTOTest {
        ...
        @Test @DisplayName("all-args constructor — set đúng")
        void allArgsConstructor() {
    ...
    @Nested @DisplayName("AutoBidRegistrationDTO")
    class AutoBidRegistrationDTOTest {
        ...
        void settersGetters() {
            BidDTOs.AutoBidRegistrationDTO dto = new BidDTOs.AutoBidRegistrationDTO();
            LocalDateTime ts = LocalDateTime.now();
            dto.setAuctionId("a-1"); dto.setMaxBid(5_000_000L);
            dto.setCurrentSystemBid(3_000_000L); dto.setActive(true);
    ...
    @Nested @DisplayName("AutoBidTriggeredDTO")
    class AutoBidTriggeredDTOTest {
        ...
        void settersGetters() {
            BidDTOs.AutoBidTriggeredDTO dto = new BidDTOs.AutoBidTriggeredDTO();
            LocalDateTime ts = LocalDateTime.now();
            dto.setAuctionId("a-1"); dto.setBidAmount(2_000_000L);
            dto.setNewCurrentPrice(2_000_000L); dto.setRemainingMaxBid(3_000_000L);
            dto.setNowLeading(true); dto.setTimestamp(ts);
    ...
    @Nested @DisplayName("AutoBidExhaustedDTO")
    class AutoBidExhaustedDTOTest {
        ...
        void settersGetters() {
            BidDTOs.AutoBidExhaustedDTO dto = new BidDTOs.AutoBidExhaustedDTO();
            dto.setAuctionId("a-1"); dto.setMaxBid(5_000_000L);
            dto.setCurrentPrice(5_100_000L); dto.setLeadingBidderUsername("rival");
            assertThat(dto.getMaxBid()).isEqualTo(5_000_000L);
    ...
    @Nested @DisplayName("BidChartPointDTO")
    class BidChartPointDTOTest {
        ...
        void settersGetters() {
            BidDTOs.BidChartPointDTO dto = new BidDTOs.BidChartPointDTO();
            LocalDateTime ts = LocalDateTime.now();
            dto.setAuctionId("a-1"); dto.setPrice(3_000_000L);
            dto.setBidderUsername("alice"); dto.setTimestamp(ts); dto.setAutoBid(true);
    ...
    @Nested @DisplayName("BidHistoryResponseDTO")
    class BidHistoryResponseDTOTest {
        ...
        @Test @DisplayName("setters / getters — roundtrip với danh sách điểm")
