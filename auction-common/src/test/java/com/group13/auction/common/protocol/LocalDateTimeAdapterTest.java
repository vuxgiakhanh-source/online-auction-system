...
class LocalDateTimeAdapterTest {
    ...
    class SerializeTest {
        ...
        @Test @DisplayName("serialize LocalDateTime → ISO-8601 string")
        ...
        @Test @DisplayName("serialize với nanoseconds — giữ đủ precision")
    ...
    class DeserializeTest {
        ...
        @Test @DisplayName("deserialize ISO-8601 string → đúng LocalDateTime")
        ...
        @Test @DisplayName("deserialize với time component đầy đủ")
        ...
        @Test @DisplayName("deserialize sai format — ném exception")
    ...
    class RoundtripTest {
        ...
        @Test @DisplayName("roundtrip — LocalDateTime không thay đổi")
        ...
        @Test @DisplayName("roundtrip nhiều giá trị — tất cả đúng")
