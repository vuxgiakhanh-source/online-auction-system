...
class PacketCodecTest {
    ...
    class EncodeTest {
        ...
        @Test @DisplayName("encode packet với payload — JSON chứa type và payload")
        ...
        @Test @DisplayName("encode packet null payload — JSON chứa \"payload\":null")
        ...
        @Test @DisplayName("encode packet với requestId null — requestId null trong JSON")
    ...
    class DecodeClassTest {
        ...
        @Test @DisplayName("roundtrip encode→decode — type, payload, requestId khớp")
        ...
        @Test @DisplayName("decode packet không có requestId — requestId null")
        ...
        @Test @DisplayName("decode packet null payload — payload null")
        ...
        @Test @DisplayName("decode với type không hợp lệ — ném IllegalArgumentException")
        ...
        @Test @DisplayName("timestamp được preserve sau roundtrip")
    ...
    class PeekTypeTest {
        ...
        @Test @DisplayName("peekType — trả đúng PacketType")
        ...
        @Test @DisplayName("peekType không deserialize payload — nhanh")
    ...
    class PeekPayloadTest {
        ...
        @Test @DisplayName("peekPayload — trả JsonElement không null")
        ...
        @Test @DisplayName("peekPayload null payload — trả JsonNull")
    ...
    class FromElementTest {
        ...
        @Test @DisplayName("fromElement — deserialize JsonElement thành DTO đúng")
    ...
    class LocalDateTimeTest {
        ...
        @Test @DisplayName("LocalDateTime roundtrip — ISO-8601 format")
    ...
    class GsonTest {
        ...
        @Test @DisplayName("gson() trả non-null instance")
        void gson_notNull() {
            assertThat(PacketCodec.gson()).isNotNull();
        }

        @Test @DisplayName("gson() trả cùng instance mỗi lần (singleton)")
