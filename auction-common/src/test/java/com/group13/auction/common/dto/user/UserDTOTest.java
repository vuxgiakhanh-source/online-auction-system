...
class UserDTOTest {
    ...
    class DefaultConstructorTest {
        @Test @DisplayName("tất cả field null / zero / false")
        void defaults() {
    ...
    class SettersGettersTest {
        ...
        @Test @DisplayName("id, username, email, accountStatus")
        void identityFields() {
            UserDTO dto = new UserDTO();
            dto.setId("u-1");
        ...
        @Test @DisplayName("roles — list preserved")
        ...
        @Test @DisplayName("financial fields — balance, lockedDeposit, availableBalance")
        ...
        @Test @DisplayName("rating — double roundtrip")
        ...
        @Test @DisplayName("hasEverBeenPenalized — set true / false")
        ...
        @Test @DisplayName("timestamps — createdAt, updatedAt")
        void timestamps() {
            UserDTO dto = new UserDTO();
        ...
        @Test @DisplayName("adminType — null cho NormalUser, MASTER/STAFF cho Admin")
    ...
    class AccountStatusTest {
        @Test @DisplayName("các giá trị hợp lệ theo contract")
