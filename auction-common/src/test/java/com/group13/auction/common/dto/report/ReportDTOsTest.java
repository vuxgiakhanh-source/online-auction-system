...
class ReportDTOsTest {
    ...
    @Nested @DisplayName("QualityReportRequestDTO")
    class QualityReportRequestDTOTest {
        @Test @DisplayName("defaults — null")
        void defaults() {
    ...
    @Nested @DisplayName("QualityReportDTO")
    class QualityReportDTOTest {
        @Test @DisplayName("defaults — null/false")
        void defaults() {
        ...
        void settersGetters_full() {
            ...
            dto.setReportId("r-1"); dto.setAuctionId("a-1");
            dto.setAuctionItemName("Laptop"); dto.setReporterId("u-1");
            dto.setReporterUsername("buyer"); dto.setSellerId("s-1");
            dto.setSellerUsername("seller"); dto.setDescription("Hàng giả");
            dto.setEvidenceUrls(Arrays.asList("url1")); dto.setStatus("PENDING");
            dto.setCreatedAt(ts); dto.setSellerRefundDeadline(ts.plusDays(1));
        ...
        @Test @DisplayName("status — PENDING / APPROVED / REJECTED")
    ...
    @Nested @DisplayName("QualityReportResultDTO")
    class QualityReportResultDTOTest {
        ...
        void settersGetters() {
            ReportDTOs.QualityReportResultDTO dto = new ReportDTOs.QualityReportResultDTO();
            dto.setReportId("r-1"); dto.setAuctionId("a-1");
            dto.setRefundedAmount(5_000_000.0); dto.setSellerRatingPenalty(1.0);
            dto.setSellerNewRating(2.5); dto.setSellerBanned(true);
