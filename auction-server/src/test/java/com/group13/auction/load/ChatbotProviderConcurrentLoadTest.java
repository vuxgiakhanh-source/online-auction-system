...
/**
 * Đồng thời nhiều luồng gọi {@link ChatbotProvider} — không cần Docker. Bảo vệ hồi quy sau khi FAQ
 * được nạp bất biến từ JSON (Gson).
 */
...
class ChatbotProviderConcurrentLoadTest {
  ...
  @Test
  @DisplayName(
      "Nhiều luồng song song: getAnswerByQuestionId + searchByQuery — không lỗi, kết quả hợp lệ")
