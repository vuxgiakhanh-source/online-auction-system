...
class AutoBidPhaseTest {
    ...
    class MultiplierTests {
        ...
        void late_greaterThan_early() {
            assertThat(AutoBidPhase.LATE.multiplier())
                    .isGreaterThan(AutoBidPhase.EARLY.multiplier());
        }

        @Test
        @DisplayName("VERY_HOT multiplier > LATE multiplier")
        void veryHot_greaterThan_late() {
            assertThat(AutoBidPhase.VERY_HOT.multiplier())
                    .isGreaterThan(AutoBidPhase.LATE.multiplier());
        }
    }
