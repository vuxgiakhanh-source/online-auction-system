 ...
 *
 * <p>Gồm {@code com.group13.auction.unit}, {@code com.group13.auction.websocket} (unit), {@code
 * com.group13.auction.security}, và {@code com.group13.auction.concurrency}. Test tải nhẹ trong
 * {@code com.group13.auction.load} có tên *Test (vd. Chatbot…) cũng chạy ở đây.
 */
public final class TestLauncher {
  ...
  public static void main(String[] args) {
    ...
    TestExecutionListener printingListener =
    ...
    System.out.println();
    System.out.printf(
        "TỔNG KẾT: %d passed / %d failed / %d skipped%n",
        summary.getTestsSucceededCount(),
        summary.getTestsFailedCount(),
        summary.getTestsSkippedCount());
    System.out.printf("Thời gian: %d ms%n", summary.getTimeFinished() - summary.getTimeStarted());
