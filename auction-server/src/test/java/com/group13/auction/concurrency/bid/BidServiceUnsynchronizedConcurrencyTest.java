...
/**
 * Bid đồng thời thật — không bọc {@link AuctionLockRegistry} bên ngoài. Mô phỏng nhiều client gọi
 * {@link BidService#placeBid} song song (như load test).
 */
...
class BidServiceUnsynchronizedConcurrencyTest extends ConcurrencyTestBase {
  ...
  void setUp() {
    ...
    when(mockBidTx.saveTransactionAndUpdatePrice(any(), anyString(), anyLong(), anyString()))
        .thenReturn(true);
