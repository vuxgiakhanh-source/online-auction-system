...
/**
 * ============================================================================
 * AuctionLockRegistryConcurrencyTest — Group A
 * Unit contract của lock per-auction (Bottom-up).
...
class AuctionLockRegistryConcurrencyTest extends ConcurrencyTestBase {
    ...
    @Test
    @Order(3)
    @DisplayName("A3: Lock phải đảm bảo mutual exclusion — chỉ 1 thread vào critical section tại 1 thời điểm")
    @Timeout(value = 5)
