...
/**
 * ============================================================================
 * BidEdgeCasesTest — Group E
 * Guard conditions và edge cases cho BidService.
 * ============================================================================
 */
...
class BidEdgeCasesTest extends ConcurrencyTestBase {
    ...
    void bidder_notJoined_throwsException() {
        ...
        assertThatThrownBy(() ->
                bidService.placeBid(notJoined, auction, STARTING_PRICE + 50_000L,
    ...
    void bannedBidder_throwsAuthenticationException() {
        ...
        assertThatThrownBy(() ->
                bidService.placeBid(banned, auction, STARTING_PRICE + 50_000L,
                        new StandardBidStrategy())
    ...
    void bid_onFinishedAuction_throwsAuctionClosedException() {
        Auction finished = Auction.reconstitute(
    ...
    @Test
    @Order(5)
    @DisplayName("E5: clearAuction() trên AutoBidRegistry xóa entry phiên, không ảnh hưởng phiên khác")
