 ...
 *
 * <p>Schema: id, user_id, auction_id, notification_type, title, body, is_read, created_at, updated_at.
...
public class NotificationDAO {
    ...
    private boolean saveWithTypeColumn(Notification notification) {
        String sql = "INSERT INTO notifications "
            + "(id, user_id, auction_id, notification_type, title, body, is_read, created_at, updated_at) "
            + "VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?)";
        try (Connection conn = DatabaseConnection.getInstance().getConnection();
            ...
            log.error("Lỗi lưu notification: userId={}, title={}",
                notification.getUserId(), notification.getTitle(), e);
            return false;
        }
    }
    ...
    private boolean saveLegacyWithoutTypeColumn(Notification notification) {
        ...
        try (Connection conn = DatabaseConnection.getInstance().getConnection();
            ...
            log.error("Lỗi lưu notification (legacy schema): userId={}, title={}",
                notification.getUserId(), notification.getTitle(), e);
            return false;
        }
    }
    ...
    public List<Notification> findByUserId(String userId) {
        String sql = "SELECT id, user_id, auction_id, notification_type, title, body, is_read, created_at, updated_at "
    ...
    private Notification mapRow(ResultSet rs) throws SQLException {
        ...
        String type = hasColumn(rs, "notification_type")
