 ...
 *
 * <ol>
 *   <li>Winner gọi {@link #submitReport} -> report ở PENDING.
 *   <li>Admin gọi {@link #approveReport} or {@link #rejectReport}.
 *   <li>Nếu approve -> trừ rating Seller, hoàn tiền winner.
 * </ol>
 */
public interface IQualityReportService {
   ...
   *
   * <p>Khi approve: chuyển status -> APPROVED, set deadline 24h cho Seller, trừ rating Seller, hoàn
   * tiền cho Winner, notify Staff.
   *
