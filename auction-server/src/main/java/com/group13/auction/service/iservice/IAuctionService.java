...
public interface IAuctionService {
  ...
  /**
   * Tạo phiên đấu giá mới ở trạng thái OPEN. Seller cung cấp reservePrice (giá sàn bí mật) ngay khi
   * tạo.
   *
  ...
  /**
   * SYSTEM tự động huỷ phiên đấu giá (no-winner / reserve-not-met / system-error). Log được ghi vào
   * SystemAdmin.
   *
  ...
  /**
   * Admin STAFF huỷ phiên đấu giá. Log được ghi vào cả SystemAdmin (audit trail) lẫn staff cụ thể.
   *
  ...
  /**
   * SystemAdmin auto duyệt yêu cầu hủy phiên của Seller (phiên chỉ được phép ở trạng thái OPEN).
   *
  ...
  void notify(Auction auction, AuctionEvent.AuctionEventType type, NormalUser bidder, long amount);
