...
/**
 * Hợp đồng xác thực người dùng (đảm nhiệm quản lý khâu login) Tách interface để tầng trên
 * (Controller) phụ thuộc vào abstraction, không phụ thuộc vào implementation cụ thể.
 */
