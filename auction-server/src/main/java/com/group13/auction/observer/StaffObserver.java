 ...
 *
 * <ul>
 *   <li>các trường hợp phiên bị hủy cần kiểm tra.
 *   <li>FRAUD_DETECTED - phát hiện gian lận cần xử lý.
 *   <li>QUALITY_REPORT_APPROVED - báo cáo chất lượng cần theo dõi hoàn tiền.
 *   <li>SELLER_CANCEL_REQUEST - seller yêu cầu hủy, staff cần xem xét và quyết định.
 * </ul>
 *
 * <p>Chỉ khi Staff joinAuction thì mới nhận thêm notify chi tiết theo phiên đó. Dữ liệu log luôn có
 * thể truy xuất sau này từ actionLog.
 */
