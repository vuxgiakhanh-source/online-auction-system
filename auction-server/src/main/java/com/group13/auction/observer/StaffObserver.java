        ...
        switch (event.getEventType()) {
            ...
            case FRAUD_DETECTED:
                String fraudLog = String.format(
                        "[THÔNG BÁO tới STAFF - %s] GIAN LẶN tại phiên %s: %s",
                        staff.getUsername(), event.getAuction().getId(),
            ...
            case QUALITY_REPORT_APPROVED:
                String reportLog = String.format(
                        "[THÔNG BÁO tới STAFF - %s] Báo cáo chất lượng được duyệt tại phiên %s — theo dõi hoàn tiền.",
                        staff.getUsername(), event.getAuction().getId());
            ...
            case SELLER_CANCEL_REQUEST:
                String requestLog = String.format(
                        "[THÔNG BÁO tới STAFF - %s] Seller yêu cầu hủy phiên %s: %s — CẦN XEM XÉT VÀ QUYẾT ĐỊNH.",
                        staff.getUsername(), event.getAuction().getId(),
