 ...
 * <h3>Hai endpoint:</h3>
 * <ul>
 *   <li>{@code POST /upload} — nhận file ảnh (raw body), lưu vào disk,
 *       trả về JSON {@code {"url":"/uploads/items/{uuid}.jpg"}}</li>
 *   <li>{@code GET  /uploads/items/{filename}} — serve file ảnh đã lưu</li>
 * </ul>
 *
 * <h3>Giới hạn:</h3>
 * <ul>
 *   <li>Kích thước file tối đa: {@value #MAX_FILE_BYTES} bytes (2 MB)</li>
 *   <li>Content-Type phải là image/* (jpg, png, webp, gif)</li>
 * </ul>
 *
 * <h3>Cách dùng:</h3>
 * <pre>{@code
