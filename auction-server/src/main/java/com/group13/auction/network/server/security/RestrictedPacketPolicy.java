...
/**
 * Whitelist packet cho tài khoản BANNED/SUSPENDED sau khi đăng nhập (restricted mode). Chỉ ví +
 * đăng xuất + ping; mọi nghiệp vụ khác bị chặn ở {@link RestrictedAccessGuard}.
 */
public final class RestrictedPacketPolicy {

  private static final Set<PacketType> ALLOWED =
      EnumSet.of(
          PacketType.LOGIN,
          PacketType.LOGOUT,
          PacketType.DEPOSIT,
