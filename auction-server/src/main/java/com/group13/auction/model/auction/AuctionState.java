 ...
 *
 * <p>Mỗi trạng thái tự biết nó có thể chuyển sang trạng thái nào tiếp theo,
 * và tự ném {@link IllegalStateException} nếu chuyển trạng thái không hợp lệ.
 *
 * <p>Lớp {@link Auction} chỉ cần gọi {@code state.start()},
 * {@code state.close()}, {@code state.cancel()}, {@code state.markPaid()}
 * mà không cần quan tâm trạng thái hiện tại là gì.
 * Sẽ phát triển (EXTENDED, DISPUTED...)
 */
