...
public class ElectronicsFactory extends ItemFactory {
  ...
  /**
   * @param args [0] brand (String), [1] warrantyMonths (int), [2] condition (String), [3] imageUrls
  ...
  protected Item createProduct(
    ...
    return Electronics.create(
        name, description, startingPrice, seller, brand, warrantyMonths, condition, imgs);
  }
}
