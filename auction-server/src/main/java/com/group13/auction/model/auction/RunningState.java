 ...
 *
 * <ul>
 *   <li>RUNNING -> FINISHED (khi {@link #close(boolean)} với hasWinner = true)
 *   <li>RUNNING -> CANCELED (khi {@link #close(boolean)} với hasWinner = false hoặc {@link
 *       #cancel()})
 * </ul>
 */
public class RunningState implements AuctionState {
  ...
  public AuctionState start() {
    throw new IllegalStateException("Phiên đã ở trạng thái RUNNING - không thể start lại.");
  }
