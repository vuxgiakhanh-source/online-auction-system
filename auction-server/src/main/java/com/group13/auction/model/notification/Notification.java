...
public class Notification extends Entity {
    ...
    public static Notification create(String userId, String auctionId, String notificationType,
                                      String title, String body) {
    ...
    public static Notification reconstitute(String id,
                                            ...
                                            String body,
                                            boolean isRead) {
        return new Notification(id, createdAt, updatedAt, userId, auctionId,
            notificationType, title, body, isRead);
    }

    // ── Constructors ───────────────────────────────────────────────────────

    private Notification(String userId, String auctionId, String notificationType,
                         String title, String body) {
        super();
        this.userId           = userId;
    ...
    private Notification(String id, LocalDateTime createdAt, LocalDateTime updatedAt,
                         String userId, String auctionId, String notificationType,
