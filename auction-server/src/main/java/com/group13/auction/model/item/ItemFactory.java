...
/** Abstract Factory tạo Item — tập trung validate và khởi tạo. ID được sinh bởi Entity (UUID). */
public abstract class ItemFactory {
  ...
  public Item create(
    ...
    return switch (cat) {
      case "ELECTRONICS" ->
          new ElectronicsFactory(ratingService)
              .createItem(
                  name,
                  description,
                  startingPrice,
      ...
      case "ART" ->
          new ArtFactory(ratingService)
              .createItem(
                  ...
                  imgs);
      case "VEHICLE" ->
          new VehicleFactory(ratingService)
              .createItem(
                  name,
                  description,
                  startingPrice,
