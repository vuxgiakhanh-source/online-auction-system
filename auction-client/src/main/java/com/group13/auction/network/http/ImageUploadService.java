...
public final class ImageUploadService {
     ...
     * Upload bytes ảnh.
     */
    public String uploadBytes(byte[] data, String contentType) throws IOException, InterruptedException {
        ...
        if (response.statusCode() != 200) {
            throw new IOException("Upload thất bại HTTP " + response.statusCode() + ": " + response.body());
        }
