 ...
 *
 * <p>Một số request chỉ có success packet rõ ràng, còn lỗi có thể trả về {@code SYSTEM_ERROR}. Vì
 * vậy {@code failureType} được để optional thay vì bắt buộc.
 */
