 ...
 *
 * <p>Lớp này giúp toàn bộ client chỉ khai báo cặp success/failure ở một nơi,
 * tránh copy-paste trong service/controller.
 */
public final class PacketExpectations {
    ...
    private static Map<PacketType, PacketExpectation> buildExpectations() {
        ...
        put(map, PacketType.GET_USER_PROFILE,
                PacketType.GET_USER_PROFILE_SUCCESS, PacketType.GET_USER_PROFILE_FAILED);
        put(map, PacketType.REQUEST_SELLER_ROLE,
                PacketType.REQUEST_SELLER_ROLE_SUCCESS, PacketType.REQUEST_SELLER_ROLE_FAILED);
        ...
        put(map, PacketType.UPDATE_AUCTION,
                PacketType.UPDATE_AUCTION_SUCCESS, PacketType.UPDATE_AUCTION_FAILED);
        put(map, PacketType.CANCEL_AUCTION_REQUEST,
                PacketType.CANCEL_AUCTION_REQUEST_SUCCESS, PacketType.CANCEL_AUCTION_REQUEST_FAILED);
        put(map, PacketType.ADMIN_CANCEL_AUCTION,
                PacketType.ADMIN_CANCEL_AUCTION_SUCCESS, PacketType.ADMIN_CANCEL_AUCTION_FAILED);
        successOnly(map, PacketType.ADMIN_GET_ALL_AUCTIONS, PacketType.ADMIN_GET_ALL_AUCTIONS_SUCCESS);

        put(map, PacketType.JOIN_AUCTION, PacketType.JOIN_AUCTION_SUCCESS, PacketType.JOIN_AUCTION_FAILED);
        put(map, PacketType.WATCH_AUCTION, PacketType.WATCH_AUCTION_SUCCESS, PacketType.WATCH_AUCTION_FAILED);
        ...
        put(map, PacketType.REGISTER_AUTO_BID,
                PacketType.REGISTER_AUTO_BID_SUCCESS, PacketType.REGISTER_AUTO_BID_FAILED);
        put(map, PacketType.UPDATE_AUTO_BID,
                PacketType.UPDATE_AUTO_BID_SUCCESS, PacketType.UPDATE_AUTO_BID_FAILED);
        put(map, PacketType.CANCEL_AUTO_BID,
                PacketType.CANCEL_AUTO_BID_SUCCESS, PacketType.CANCEL_AUTO_BID_FAILED);
        successOnly(map, PacketType.GET_AUTO_BID_STATUS, PacketType.GET_AUTO_BID_STATUS_SUCCESS);
        put(map, PacketType.GET_BID_HISTORY,
                PacketType.GET_BID_HISTORY_SUCCESS, PacketType.GET_BID_HISTORY_FAILED);

        put(map, PacketType.ADMIN_BAN_USER,
                PacketType.ADMIN_BAN_USER_SUCCESS, PacketType.ADMIN_BAN_USER_FAILED);
        ...
        put(map, PacketType.ADMIN_APPROVE_SELLER_ROLE,
                PacketType.ADMIN_APPROVE_SELLER_ROLE_SUCCESS, PacketType.ADMIN_APPROVE_SELLER_ROLE_FAILED);
        ...
        successOnly(map, PacketType.ADMIN_REJECT_QUALITY_REPORT,
