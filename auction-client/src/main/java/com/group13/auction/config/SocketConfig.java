 ...
 *
 * <p>Các giá trị có thể override bằng system property khi chạy Maven/IDE, ví dụ: {@code
 * -Dauction.server.host=localhost -Dauction.server.port=8080}.
 */
  ...
  public static URI serverUri() {
    ...
    try {
      ...
      throw new IllegalStateException(
          "Không thể tạo WebSocket URI từ cấu hình hiện tại.", exception);
    }
  }
