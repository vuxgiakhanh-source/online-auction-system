...
public final class QualityReportReviewController {
    ...
    private void handleRejectReport() {
        ...
        qualityReportService
                ...
                .whenComplete((ignored, throwable) -> handleMutationResult("Đã từ chối report.", throwable));
    }
    ...
    private void configureSelectionBinding() {
        ...
        reportTable
                ...
                .addListener((observable, oldValue, selectedReport) -> renderSelectedReport(selectedReport));
    }
