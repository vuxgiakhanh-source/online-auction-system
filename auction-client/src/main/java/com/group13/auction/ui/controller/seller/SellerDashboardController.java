...
public final class SellerDashboardController {
    ...
    private void renderSellerInfo() {
        ...
        String roleText = session.getRoles().isEmpty() ? "Chưa có vai trò" : String.join(", ", session.getRoles());
        sellerStatusLabel.setText("Vai trò: " + roleText + "  •  Trạng thái: " + session.getAccountStatus());
    }
    ...
    private String extractMessage(Throwable throwable) {
        ...
        return current.getMessage() == null ? "Có lỗi xảy ra khi xử lý Seller dashboard." : current.getMessage();
    }
}