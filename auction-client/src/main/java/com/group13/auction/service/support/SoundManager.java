 ...
 *
 * <p><b>Deprecated:</b> tất cả code mới phải gọi {@link AudioManager} trực tiếp.
 * Class này sẽ bị xóa trong phiên bản tiếp theo.
 *
 * <p>Lý do: SoundManager chỉ là wrapper 1-1 sang AudioManager mà không thêm logic nào.
 * Duy trì 2 lớp cho cùng chức năng làm tăng confusion khi đọc code.
 */
