 ...
 *
 * <p>Client chỉ gọi API admin thật của server. Các rule như phiên nào được hủy, trạng thái sau khi
 * hủy, hoàn tiền hay xử lý người thắng là trách nhiệm của server.
 */
