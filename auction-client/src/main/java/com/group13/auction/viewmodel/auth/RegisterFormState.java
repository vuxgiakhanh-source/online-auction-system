...
public final class RegisterFormState {
   ...
   *
   * <p>Constructor này giữ tương thích với code cũ. Flow UI nên dùng constructor có {@code
   * confirmPassword} để validate đầy đủ hơn.
   *
   ...
   */
  public RegisterFormState(String email, String username, String password, String confirmPassword) {
